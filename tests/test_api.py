...
class TestFlaskApp(unittest.TestCase):
    ...
    @patch("app.smart_lock_controller.create_key_code")
    ...
    @patch("app.smart_lock_controller.delete_key_code")
    ...
    @patch("app.smart_lock_controller.list_devices")
    ...
    @patch("app.smart_lock_controller.list_key_codes")
